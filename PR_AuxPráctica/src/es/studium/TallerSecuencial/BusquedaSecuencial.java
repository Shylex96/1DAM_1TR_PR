...
public class BusquedaSecuencial
{
	...
	public static void main(String[] args)
	{
		...
		// 4º 1-mientras !no lo encuentre, seguir buscando, 2-no haya llegado al final de la tabla 
		// (necesario para que si el elemento no está en la tabla, pare cuando llegue al final de la tabla)
